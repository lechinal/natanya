...
export const MENIU = [
  ...
  },
  {
    ...
    emoji: "🍗",
    items: [
      { nume: "4 aripioare", desc: "+ cartofi (150g) + sos caramel (30g)", pret: "25 Lei", gramaj: "" },
      { nume: "8 aripioare", desc: "+ cartofi (200g) + sos caramel (30g)", pret: "35 Lei", gramaj: "" },
      { nume: "12 aripioare", desc: "+ cartofi (250g) + sos caramel (30g)", pret: "43 Lei", gramaj: "" },
    ],
  },
  {
  ...
  },
  {
    ...
    emoji: "🎁",
    items: [
      { nume: "Combo Șnițel la lipie + suc", desc: "", pret: "35 Lei", gramaj: "" },
  ...
  },
  {
    ...
    emoji: "🥤",
    items: [
      { nume: "Coca-Cola / Fanta / Sprite", desc: "500 ml", pret: "10 Lei", gramaj: "" },
      { nume: "Coca-Cola / Fanta / Sprite", desc: "330 ml", pret: "8 Lei", gramaj: "" },
      { nume: "Apă plată / carbogazoasă", desc: "500 ml", pret: "8 Lei", gramaj: "" },
    ],
  },
  {
    ...
    items: [
      ...
      { nume: "Lipie Natanya proaspătă", desc: "200g", pret: "5 Lei", gramaj: "" },
    ],
  },
];
...
export const CHAT_REPLIES = [
  ...
  "Lipia Natanya e preparată la comandă, proaspătă de fiecare dată! 🥙",
